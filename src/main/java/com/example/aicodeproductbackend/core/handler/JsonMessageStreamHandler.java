package com.example.aicodeproductbackend.core.handler;

import cn.hutool.core.io.FileUtil;
import cn.hutool.core.util.StrUtil;
import cn.hutool.json.JSONObject;
import cn.hutool.json.JSONUtil;
import com.example.aicodeproductbackend.ai.model.message.*;
import com.example.aicodeproductbackend.ai.tools.BaseTool;
import com.example.aicodeproductbackend.ai.tools.ToolManager;
...
public class JsonMessageStreamHandler {
    ...
    private String handleJsonMessageChunk(String chunk, StringBuilder chatHistoryStringBuilder, Set<String> seenToolIds) {
        ...
        if (typeEnum == null) {
            throw new BusinessException(ErrorCode.SYSTEM_ERROR, "无效的消息类型");
        }
        switch (typeEnum) {
            case AI_RESPONSE -> {

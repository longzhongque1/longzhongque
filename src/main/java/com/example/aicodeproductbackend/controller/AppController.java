...
import com.example.aicodeproductbackend.common.DeleteRequest;
...
import com.example.aicodeproductbackend.model.dto.app.*;
...
public class AppController {
    ...
    @Cacheable(value = "good_app_page",
            key = "T(com.example.aicodeproductbackend.utils.CacheKeyUtils).generateKey(#appQueryRequest)",

package com.example.aicodeproductbackend.langgraph4j;
...
import com.example.aicodeproductbackend.langgraph4j.model.QualityResult;
import com.example.aicodeproductbackend.langgraph4j.node.*;
        ...
        try {
            return new MessagesStateGraph<String>()
                    ...
                    .addConditionalEdges("code_quality_check", edge_async(this::routeAfterQualityCheck),
                            Map.of("build","project_builder",//需要构建目录
                                    "skip_build",END,//不需要构建目录
                                    "fail","code_generator"))//循环检查代码格式
                    // 编译工作流
                    .compile();
